...
public:
	...
	virtual void		attach(CNode* pParent, bool isUpdateTranslate=true);				
	virtual void		deAttach(bool isUpdateTranslate=true);
	virtual void		addChild(CNode* pChild, bool isUpdateTranslate=true);	
	virtual void		removeAllChild(bool isUpdateTranslate=true);
	...
	CNode*				_findNode(CNode* pParent, const CString& name)const;
	void				_deleteAllChildNode(CNode* pParent);
