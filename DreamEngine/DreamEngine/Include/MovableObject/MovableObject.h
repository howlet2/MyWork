...
public:
	...
	void				setTypeName(const CString& typeName);
	const CString&		getTypeName(void)const			{return m_typeName;}
	...
	const RenderDataLst& getRenderDataLst(void)const		{return m_renderData;}
