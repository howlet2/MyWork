...
public:
	...
	CHardwareBuffer(const CString& name, HardwareBufferType type=TRIANGLE_LIST);
	...
	virtual const CString&		getName(void)const		{return m_name;}
...
public:
	CIndexBuffer(const CString& name, HardwareBufferType type=TRIANGLE_LIST);
...
public:
	...
	CVertexBuffer(const CString& name, HardwareBufferType type=TRIANGLE_LIST);
