...
CD3D9IndexBuffer::CD3D9IndexBuffer( const CString& name,
									CD3D9Device* pDevice, 
...
bool CD3D9IndexBuffer::createBuffer(void* pData, m_uint16 count, m_uint16 strade)
{
	...
	memcpy(pVIData, pData, m_dataCount*m_strade);
