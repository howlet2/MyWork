...
{
CD3D9VertexBuffer::CD3D9VertexBuffer(const CString& name, 
									 CD3D9Device* pDevice, 
									 HardwareBufferType type/*=TRIANGLE_LIST*/):
									 CVertexBuffer(name,type),
									 m_pDevice(pDevice),
...
bool CD3D9VertexBuffer::createBuffer(void* pData, m_uint16 count, m_uint16 strade)
{
	...
	memcpy(pVBData, pData, m_dataCount*m_strade);
