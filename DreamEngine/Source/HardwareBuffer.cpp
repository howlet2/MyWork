...
{
CHardwareBuffer::CHardwareBuffer(HardwareBufferType type/*=TRIANGLE_STRIP*/):
m_type(type),
m_strade(0),
m_dataCount(0)
{
...
CIndexBuffer::CIndexBuffer(HardwareBufferType type/*=TRIANGLE_STRIP*/):
CHardwareBuffer(type)
{
...
////////////////////////////////////////////////////////////////////////// CVertexBuffer
CVertexBuffer::CVertexBuffer(HardwareBufferType type/*=TRIANGLE_STRIP*/):
CHardwareBuffer(type)
{
}
