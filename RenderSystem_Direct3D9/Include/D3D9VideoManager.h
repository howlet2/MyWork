...
public:
	...
	virtual CIndexBuffer*  createIndexBuffer(HardwareBufferType type=TRIANGLE_LIST);
	...
	virtual CVertexBuffer* createVertexBuffer(HardwareBufferType type=TRIANGLE_LIST);
